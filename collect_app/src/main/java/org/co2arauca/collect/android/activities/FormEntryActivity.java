...
import org.co2arauca.collect.android.R;
import org.co2arauca.collect.android.application.Collect;
import org.co2arauca.collect.android.dao.FormsDao;
import org.co2arauca.collect.android.dao.InstancesDao;
import org.co2arauca.collect.android.exception.GDriveConnectionException;
import org.co2arauca.collect.android.exception.JavaRosaException;
import org.co2arauca.collect.android.listeners.AdvanceToNextListener;
import org.co2arauca.collect.android.listeners.FormLoaderListener;
import org.co2arauca.collect.android.listeners.FormSavedListener;
import org.co2arauca.collect.android.listeners.SavePointListener;
import org.co2arauca.collect.android.logic.FormController;
import org.co2arauca.collect.android.logic.FormController.FailedConstraint;
import org.co2arauca.collect.android.utilities.TimerLogger;
import org.co2arauca.collect.android.preferences.AdminKeys;
import org.co2arauca.collect.android.preferences.AdminPreferencesActivity;
import org.co2arauca.collect.android.preferences.PreferenceKeys;
import org.co2arauca.collect.android.preferences.PreferencesActivity;
import org.co2arauca.collect.android.provider.FormsProviderAPI.FormsColumns;
import org.co2arauca.collect.android.provider.InstanceProviderAPI;
import org.co2arauca.collect.android.provider.InstanceProviderAPI.InstanceColumns;
import org.co2arauca.collect.android.tasks.FormLoaderTask;
import org.co2arauca.collect.android.tasks.SavePointTask;
import org.co2arauca.collect.android.tasks.SaveResult;
import org.co2arauca.collect.android.tasks.SaveToDiskTask;
import org.co2arauca.collect.android.utilities.ApplicationConstants;
import org.co2arauca.collect.android.utilities.FileUtils;
import org.co2arauca.collect.android.utilities.MediaUtils;
import org.co2arauca.collect.android.utilities.ToastUtils;
import org.co2arauca.collect.android.views.ODKView;
import org.co2arauca.collect.android.widgets.QuestionWidget;
import org.co2arauca.collect.android.widgets.StringWidget;
